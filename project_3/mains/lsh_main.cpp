        ...
        for(int i=0;i<number_of_queries;i++) {
            ...
            if(radius>0) {
                ...
                for(int lsh_rs_index:lsh_rs_indexes) {
                    ...
                    std::cout<<"Distance from query: "<<VecMath::dist_o(query_o,DataHandler::get_data_point_at_o(lsh_rs_index))<<std::endl;
                }  
            }
            ...
            for(int lsh_nn_index:lsh_nn_indexes) {
                ...
                // Project 3 - distances calculated on original dimensions
                std::cout<<"Distance from query: "<<VecMath::dist_o(query_o,DataHandler::get_data_point_at_o(lsh_nn_index))<<std::endl;
            }    
            ...
            for(int j=1;j<=number_of_nearest;j++) {
                ...
                // Project 3 - distances calculated on original dimensions
                out_stream<<"distanceLSH: "<<VecMath::dist_o(query_o,DataHandler::get_data_point_at_o(lsh_nn_indexes[j-1]))<<std::endl;
            ...
            // Project 3 - distances calculated on original dimensions
            double AF = VecMath::dist_o(query_o,DataHandler::get_data_point_at_o(lsh_nn_indexes[0]))/VecMath::dist_o(query_o,DataHandler::get_data_point_at_o(exact_nn_indexes[0]));
