...
std::vector<int> NearestNeighbor::query_KNN_o(Datapoint query,int K){
	// setup result
	...
	for(int i=0;i<size;i++){
		...
		double datapoint_distance=VecMath::dist_o(query,DataHandler::get_data_point_at_o(datapoint_index));
