...
public:
	...
	static void load_data_latent(std::string path,int n);
	static void load_data_mnist(std::string path,int n=0);
	static void load_queries_latent(std::string path,int n);
	...
	static Datapoint get_data_point_at_o(int i);
	static Datapoint get_test_query_at_o(int i);
	static void print_data_point_o(Datapoint point, int ascii=0);
	static void print_data_point_at_o(int i, int ascii=0);

private:

	// members
	static Dataset data_points;
	static Dataset data_points_original;
	static Labels  data_labels;
	static int     dataset_size;
	static Dataset test_queries;
	static Dataset test_queries_original;
